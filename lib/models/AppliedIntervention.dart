...
class AppliedIntervention extends Model {
  ...
  const AppliedIntervention._internal({required this.id, required whoDidIt, required intervention, location, required executedSurveys, schemeVersion, entityAppliedInterventionsId, required appliedInterventionWhoDidItId, required appliedInterventionInterventionId}): _whoDidIt = whoDidIt, _intervention = intervention, _location = location, _executedSurveys = executedSurveys, _schemeVersion = schemeVersion, _entityAppliedInterventionsId = entityAppliedInterventionsId, _appliedInterventionWhoDidItId = appliedInterventionWhoDidItId, _appliedInterventionInterventionId = appliedInterventionInterventionId;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'whoDidIt': _whoDidIt?.toJson(), 'intervention': _intervention?.toJson(), 'location': _location?.toJson(), 'executedSurveys': _executedSurveys?.map((ExecutedSurvey? e) => e?.toJson()).toList(), 'schemeVersion': _schemeVersion, 'entityAppliedInterventionsId': _entityAppliedInterventionsId, 'appliedInterventionWhoDidItId': _appliedInterventionWhoDidItId, 'appliedInterventionInterventionId': _appliedInterventionInterventionId
  };
