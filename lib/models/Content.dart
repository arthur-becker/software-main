...
class Content extends Model {
  ...
  const Content._internal({required this.id, required name, description, required interventions, required tags, schemeVersion}): _name = name, _description = description, _interventions = interventions, _tags = tags, _schemeVersion = schemeVersion;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'description': _description, 'interventions': _interventions?.map((InterventionContentRelation? e) => e?.toJson()).toList(), 'tags': _tags?.map((ContentTag? e) => e?.toJson()).toList(), 'schemeVersion': _schemeVersion
  };
