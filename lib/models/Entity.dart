...
class Entity extends Model {
  ...
  const Entity._internal({required this.id, required name, description, parentEntityID, required level, location, required customData, required appliedInterventions, schemeVersion, required entityLevelId}): _name = name, _description = description, _parentEntityID = parentEntityID, _level = level, _location = location, _customData = customData, _appliedInterventions = appliedInterventions, _schemeVersion = schemeVersion, _entityLevelId = entityLevelId;
