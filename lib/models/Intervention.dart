...
class Intervention extends Model {
  ...
  const Intervention._internal({required this.id, required name, description, required interventionType, required contents, required surveys, required tags, schemeVersion, levelAllowedInterventionsId}): _name = name, _description = description, _interventionType = interventionType, _contents = contents, _surveys = surveys, _tags = tags, _schemeVersion = schemeVersion, _levelAllowedInterventionsId = levelAllowedInterventionsId;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'description': _description, 'interventionType': enumToString(_interventionType), 'contents': _contents?.map((InterventionContentRelation? e) => e?.toJson()).toList(), 'surveys': _surveys?.map((Survey? e) => e?.toJson()).toList(), 'tags': _tags?.map((InterventionTag? e) => e?.toJson()).toList(), 'schemeVersion': _schemeVersion, 'levelAllowedInterventionsId': _levelAllowedInterventionsId
  };
