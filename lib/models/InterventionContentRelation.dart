...
class InterventionContentRelation extends Model {
  ...
  const InterventionContentRelation._internal({required this.id, required intervention, required content}): _intervention = intervention, _content = content;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'intervention': _intervention?.toJson(), 'content': _content?.toJson()
  };
