...
class InterventionTag extends Model {
  ...
  const InterventionTag._internal({required this.id, required text, schemeVersion, interventionTagsId}): _text = text, _schemeVersion = schemeVersion, _interventionTagsId = interventionTagsId;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'text': _text, 'schemeVersion': _schemeVersion, 'interventionTagsId': _interventionTagsId
  };
