...
class Survey extends Model {
  ...
  const Survey._internal({required this.id, required name, description, intervention, required questions, required tags, required surveyType, schemeVersion}): _name = name, _description = description, _intervention = intervention, _questions = questions, _tags = tags, _surveyType = surveyType, _schemeVersion = schemeVersion;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'description': _description, 'intervention': _intervention?.toJson(), 'questions': _questions?.map((Question? e) => e?.toJson()).toList(), 'tags': _tags?.map((SurveyTag? e) => e?.toJson()).toList(), 'surveyType': enumToString(_surveyType), 'schemeVersion': _schemeVersion
  };
