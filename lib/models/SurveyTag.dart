...
class SurveyTag extends Model {
  ...
  const SurveyTag._internal({required this.id, required text, schemeVersion, surveyTagsId}): _text = text, _schemeVersion = schemeVersion, _surveyTagsId = surveyTagsId;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'text': _text, 'schemeVersion': _schemeVersion, 'surveyTagsId': _surveyTagsId
  };
