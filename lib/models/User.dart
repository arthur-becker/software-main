...
class User extends Model {
  ...
  const User._internal({required this.id, required firstName, required lastName, bio, required permissions, schemeVersion}): _firstName = firstName, _lastName = lastName, _bio = bio, _permissions = permissions, _schemeVersion = schemeVersion;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'firstName': _firstName, 'lastName': _lastName, 'bio': _bio, 'permissions': _permissions?.map((Permission? e) => e?.toJson()).toList(), 'schemeVersion': _schemeVersion
  };
